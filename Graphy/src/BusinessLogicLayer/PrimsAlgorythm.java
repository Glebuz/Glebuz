 ...
 * @author Glebuz
 */
public class PrimsAlgorythm extends Rebro {

    public PrimsAlgorythm(int startEdgeNumber, int finishEdgeNumber, int nextWay) {
    ...
    public String Prima ()
    {
        ...
        for (int i = 0; i < countOfNodes; i++)
        {
            ...
            {
                if (theAdjacencyMatrix[i][j] > maxWay) maxWay = theAdjacencyMatrix[i][j];// находим макс путь
            }
        }
////////////////////////////////////////////////////////////////////////////////        
        startEdgeNumber = 0;
...
////////////////////////////////////////////////////////////////////////////////     
        while (contin == true)// до тех пор, пока продолжать = true
        {
            ...
            {                    
                if (!usedNodes[i] && theAdjacencyMatrix[startEdgeNumber][i] > 0 && theAdjacencyMatrix[startEdgeNumber][i] <= minWay)
            ...
            for (int i = 0; i < countOfNodes; i++)
            {
                if (theAdjacencyMatrix[startEdgeNumber][i] > 0 && !usedNodes[i])
